...
CREATE TABLE "public"."SiteContent" (
    ...
    "musicTitle" TEXT NOT NULL DEFAULT 'Chorus Member',
    ...
    "canadaTitle" TEXT NOT NULL DEFAULT '10 Years Abroad',
    ...
    "womanTitle" TEXT NOT NULL DEFAULT 'Leading with Craft',
    ...
    "animalTitle" TEXT NOT NULL DEFAULT 'Companion',
